...
$CMD ../../csvs/french/set.csv ../../web/csvs/french/set.html -d $'\t' -q $'"' -o
...
$CMD ../../csvs/german/set.csv ../../web/csvs/german/set.html -d $'\t' -q $'"' -o
...
$CMD ../../csvs/italian/set.csv ../../web/csvs/italian/set.html -d $'\t' -q $'"' -o
...
$CMD ../../csvs/spanish/set.csv ../../web/csvs/spanish/set.html -d $'\t' -q $'"' -o
