...
2. Get the tcgplayerGroupId (I suggest doing a text search on TCGCSV's [Flesh and Blood group CSV](https://tcgcsv.com/tcgplayer/62/groups)) and setId for the set you wish to populate.
