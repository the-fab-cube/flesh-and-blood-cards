...
def generate_all_table_data(conn = None, url_for_images = None):
    def generate_non_english_table_data(cur, language):
        ...
        generate_table_data.set_printing.generate_table_data(cur, language, url_for_images)
    ...
    generate_table_data.set_printing.generate_table_data(cur, "english", url_for_images)
